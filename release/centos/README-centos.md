(centos) What is Zing? ![Zulu Duke in a Box][1]
======================================
...
The Zing azul/zing repository provides various Centos Docker image tags. The most recent Zing versions of OpenJDK 11 and 8 are listed below:
...
For a Zing 11 container, enter:
    ...
    docker run -it --rm azul/zing-centos:11 java -version

For a Zing 8 container, enter:

    docker run -it --rm azul/zing-centos:8 java -version
